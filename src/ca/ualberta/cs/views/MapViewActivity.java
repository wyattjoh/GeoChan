...
public class MapViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    Integer postType = (Integer) getIntent().getExtras().getInt("postType");
...
//	    	markSelfOnMap();
	...
	public void markSelfOnMap() {
    	Location thisLocation = (Location) getIntent().getExtras().getParcelable("selfLocation");
    	GeoPoint gp_postLocation = new GeoPoint(thisLocation.getLatitude(), thisLocation.getLongitude());
	...
	public void printLocation() {
		Location goToLocation = (Location) getIntent().getExtras().getParcelable("selfLocation");
		try {
